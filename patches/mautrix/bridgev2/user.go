...
// HasCommandState returns true if the user has a pending command state
// (e.g., waiting for input during a multi-step login flow).
func (u *User) HasCommandState() bool {
	return atomic.LoadPointer(&u.CommandState) != nil
}
